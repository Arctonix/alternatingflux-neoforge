 ...
 *
 * Relay: reuses IE EnergyConnectorBlockEntity with voltage="AF". IE 8.x exposes
 * a public constructor EnergyConnectorBlockEntity(String voltage, boolean relay,
 * BlockPos, BlockState) — identical to 9.x — and the same SPEC_TO_TYPE /
 ...
 * abstract in 8.x and is the friendly extension point.
 *
 ...
 * for 1.18.2 we use ForgeRegistries.BLOCK_ENTITY_TYPES.
 */
public final class AFBlocks
{
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, AlternatingFlux.MODID);
    // ForgeRegistries.BLOCK_ENTITIES is the correct key for 1.18.2 Forge 40.x.
    // (Renamed to BLOCK_ENTITY_TYPES in later Forge; net.minecraft.core.registries.Registries
    // is 1.19.3+ only.)
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, AlternatingFlux.MODID);
