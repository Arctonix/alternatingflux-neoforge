...
A long-distance, low-loss power transmission tier for [Immersive Engineering](https://www.curseforge.com/minecraft/mc-mods/immersive-engineering) on **Minecraft 1.18.2 / Forge**.

> **Alternating Flux** was originally created by **AntiBlueQuirk** for Minecraft 1.12.2.
> This is an updated port to 1.18.2 / Forge by **Arctonix**, with the original
...
> **Note:** This is the **stable** 1.18.2 / Forge line, at feature parity with the
...
- Minecraft **1.18.2**
- **Forge** 40.x (built against 40.3.12)
- **Immersive Engineering** 8.4.x (required dependency — install it alongside this mod)
