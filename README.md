...
A long-distance, low-loss power transmission tier for [Immersive Engineering](https://www.curseforge.com/minecraft/mc-mods/immersive-engineering) on **Minecraft 1.19.2 / Forge**.

> **Alternating Flux** was originally created by **AntiBlueQuirk** for Minecraft 1.12.2.
> This is an updated port to 1.19.2 / Forge by **Arctonix**, with the original
...
> **Note:** This is the **stable** 1.19.2 / Forge line, at feature parity with the
> published [1.21.1 / NeoForge](https://github.com/Arctonix/alternatingflux-neoforge)
> **v1.0.5** release (AF tier only). The separate `1.19.2-forge` branch carries an
