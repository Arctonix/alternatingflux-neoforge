...
> **Note:** This 1.20.1 line is an **alpha**. It backports the published 1.21.1 / NeoForge
> release and adds the UAF tier; expect rough edges.
...
2. Place **UAF Wire Relays** (a taller relay post) and string UAF coil between them.
3. Bridge UAF to lower tiers with one of the two transformers:
   - the **HV–UAF Transformer** steps between HV and UAF, and
   - the **AF–UAF Transformer** steps between AF and UAF.
...
- **Arctonix** — 1.20.1 / Forge port and the UAF tier.
